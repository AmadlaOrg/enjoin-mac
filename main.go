...
import (
	...
	"github.com/AmadlaOrg/enjoin-mac/mac"
...
var rootCmd = &cobra.Command{
	Use:     appName,
	Short:   "Enjoin plugin for Mandatory Access Control (SELinux/AppArmor)",
	Version: version,
}
	...
	infoCmd = &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			metadata := map[string]any{
				...
				"version":     version,
				"engine":      "mac",
				"supports":    []string{"amadla.org/entity/security/mac@^v1.0.0", "amadla.org/entity/security/mac/selinux@^v1.0.0", "amadla.org/entity/security/mac/apparmor@^v1.0.0"},
				"description": "Manages Mandatory Access Control via SELinux or AppArmor",
			}
...
var (
	...
	applyCmd = &cobra.Command{
		Use:   "apply",
		Short: "Apply MAC configuration (SELinux or AppArmor)",
		RunE:  runApply,
	}

	validateCmd = &cobra.Command{
		Use:   "validate",
		Short: "Validate MAC configuration without changes",
		RunE:  runValidate,
	}
)
...
func parseInput(data []byte) (*mac.Config, error) {
